...
5.  You can create tables using Markdown, type in the following and knit to see it looks like.
...
6.  Copy-and-paste one of the above tables and then add a fifth column.
...
7.  Type the following code block into your file, then click the green "play" icon that appears to the right of your code block.
...
*   Give the *pull request* the following title: [Submission: Homework 5, FirstName LastName]{.monospace}, replacing [FirstName]{.monospace} and [LastName]{.monospace} with your actual first and last name.
