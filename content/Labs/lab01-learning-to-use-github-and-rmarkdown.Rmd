...
This lab course is the complement to CDS-101: Introduction to Computational and Data Sciences, providing you with additional opportunities to practice and hone your skills.
...
For this first lab, we request that you use the lab computers instead of your personal laptop, as installing and setting up everything takes some time.
</div>
...
Once you and your lab partner have each created an account, [click here to access the template file for Lab 1]().
When you access the link, you will be given the option to either create a new group or join an existing one.
If your partner has created a group, then you can join it.
If your partner hasn't created a group yet, then create a new one and name your team using your last names.
For example, if your last names are Smith and Johnson, then name your group "Smith-and-Johnson", note that you should use hyphens instead of spaces.

Enter the Lab01 repository on GitHub (this is still online).
...
1.  Once you have your `Lab01` template file open in RStudio, write down the name you selected for your team.
...
2.  Fill in your name and other information in the spaces at the top of the file if you haven't already.
...
3.  Type the code in the box below into your lab report file exactly you see it.
...
4.  You can create tables using Markdown, type in the following and knit to see it looks like.
...
5.  Copy-and-paste one of the above tables and then add a fifth column.
...
6.  Type the following code block into your file, then click the green "play" icon that appears to the right of your code block.
...
7.  What output do you get if you type the following in a code block?
