...
@.  Visualize the dataset distribution as a boxplot --- use `geom_boxplot()` --- and as a probability mass function (PMF) --- use `geom_histogram()` with `y = ..density..` inside `aes()` --- with a binwidth that allows you can see the full dataset (only identical numbers should have counts larger than 1).
