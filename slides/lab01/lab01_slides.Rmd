...
output:
  xaringan::moon_reader:
    lib_dir: libs
    css: [libs/css/default.css, libs/css/cds101.css, libs/css/cds101-fonts.css]
    seal: false
    chakra: libs/js/remark-latest.min.js
    nature:
...
knitr::include_graphics("img/cds-101-logo.png")
```
]
...
* Type the following in your *Console* window to install the necessary packages to get started:
...
# Using symbols to "mark up" your document
